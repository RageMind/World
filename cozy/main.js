...
const assets={grass:null};

fetch('assets/grass_chunk.webp.b64?v=4').then(r=>r.text()).then(b64=>{
  const img=new Image();
  img.onload=()=>{assets.grass=img};
